...
def attack(char_name: str, char_class: str) -> str:
    """Allow you to determine the degree of the player's attack."""
...
def defence(char_name: str, char_class: str) -> str:
    """Appear the strength of the response to the player's attack."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Character class selection block."""
